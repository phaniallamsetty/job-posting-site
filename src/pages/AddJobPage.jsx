        ...
        <section className="bg-indigo-50">
            <div className="container m-auto max-w-2xl py-24">
                <div className="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0">
                    <form>
                        <h2 className="text-3xl text-xenter font-semibold mb-6">Add Job</h2>
                        ...
                        <div className="mb-4">
                            ...
                            <input type="text" id="title" name="title"
                                ...
                                placeholder="Eg. Senior Software Engineer" required
                                value={title}
                        ...
                        <div className="mb-4">
                            <label htmlFor="salary" class="block text-gray-700 font-bold mb-2">
                                Salary
                            </label>
                        ...
                        <div className="mb-4">
                            <label htmlFor="company" className="blick text-gray-700 font-bold mb-2">
                                Company Name
                            </label>
                        ...
                        <div className="mb-4">
                            ...
                            <textarea id="company_description" name="company_description"
                                className="border rounded w-full py-2 px-3" rows="4"
